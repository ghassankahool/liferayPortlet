...
import net.gbcoder.gblib.model.BookModel;
import net.gbcoder.gblib.model.BookSoap;
 ...
 *
 * <p>
 * This implementation and its corresponding interface {@link net.gbcoder.gblib.model.BookModel} exist only as a container for the default property accessors generated by ServiceBuilder. Helper methods and all application logic should be put in {@link BookImpl}.
 * </p>
 *
 * @author GL
 * @see BookImpl
 * @see net.gbcoder.gblib.model.Book
 * @see net.gbcoder.gblib.model.BookModel
 * @generated
 */
@JSON(strict = true)
public class BookModelImpl extends BaseModelImpl<Book> implements BookModel {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify or reference this class directly. All methods that expect a Book model instance should use the {@link net.gbcoder.gblib.model.Book} interface instead.
	 */
	...
	public static final boolean ENTITY_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.entity.cache.enabled.net.gbcoder.gblib.model.Book"),
			true);
	public static final boolean FINDER_CACHE_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.finder.cache.enabled.net.gbcoder.gblib.model.Book"),
			true);
	public static final boolean COLUMN_BITMASK_ENABLED = GetterUtil.getBoolean(com.liferay.util.service.ServiceProps.get(
				"value.object.column.bitmask.enabled.net.gbcoder.gblib.model.Book"),
			true);
	...
	public static Book toModel(BookSoap soapModel) {
		...
		model.setBookPricae(soapModel.getBookPricae());
		model.setBookDate(soapModel.getBookDate());
	...
	public static final long LOCK_EXPIRATION_TIME = GetterUtil.getLong(com.liferay.util.service.ServiceProps.get(
				"lock.expiration.time.net.gbcoder.gblib.model.Book"));
	...
	public Object clone() {
		...
		bookImpl.setBookPricae(getBookPricae());
		bookImpl.setBookDate(getBookDate());
	...
	public CacheModel<Book> toCacheModel() {
		...
		bookCacheModel.bookPricae = getBookPricae();

		Date bookDate = getBookDate();

		if (bookDate != null) {
			bookCacheModel.bookDate = bookDate.getTime();
		}
		else {
			bookCacheModel.bookDate = Long.MIN_VALUE;
		}
