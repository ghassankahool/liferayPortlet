...
public class AuthorLocalServiceClp implements AuthorLocalService {
	...
	public net.gbcoder.gblib.model.Author addAuthor(
		...
		return (net.gbcoder.gblib.model.Author)ClpSerializer.translateOutput(returnObj);
	}
	...
	public java.util.List<net.gbcoder.gblib.model.Author> getAuthors(
		...
		return (java.util.List<net.gbcoder.gblib.model.Author>)ClpSerializer.translateOutput(returnObj);
	}
